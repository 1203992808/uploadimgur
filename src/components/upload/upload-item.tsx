    ...
    <Card className="w-full">
      <CardContent className="p-4">
        <div className="flex flex-col space-y-4">
          ...
          {/* Content Layout - Consistent for all states */}
          <div className="flex items-start space-x-4">
            {/* Preview - Always shown on left */}
              ...
              {uploadFile.preview && (
                <div className="flex flex-col space-y-2">
                  ...
                  <img
                    ...
                    className="w-16 h-16 object-cover rounded-md border-2 border-red-500"
                  />
                  {/* File Info - Always below image */}
            ...
            <div className="flex-1 min-w-0">
              ...
              {uploadFile.status === 'pending' && (
                <div className="space-y-3 flex items-center justify-center h-16">
